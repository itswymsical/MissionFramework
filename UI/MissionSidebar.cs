...
using MissionFramework.Utilities;
...
namespace MissionFramework.Common.UI.Missions;
...
public class MissionSidebar
{
    ...
    {
        iconTexture = ModContent.Request<Texture2D>("MissionFramework/Assets/Textures/UI/Missions/MissionAvailable", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        nextTexture = ModContent.Request<Texture2D>("MissionFramework/Assets/Textures/UI/Missions/Next", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        prevTexture = ModContent.Request<Texture2D>("MissionFramework/Assets/Textures/UI/Missions/Prev", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        toggleTexture = ModContent.Request<Texture2D>("MissionFramework/Assets/Textures/UI/Missions/CycleMenu", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        pinTexture = ModContent.Request<Texture2D>("MissionFramework/Assets/Textures/UI/Missions/Pin", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
    }
    ...
    private void DrawHoverText(SpriteBatch spriteBatch, string text)
    {
        ...
        PanelRenderer.DrawPanel(spriteBatch, hoverBg, new Color(63, 65, 161) * 0.8f * alpha);
    ...
    public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
    {
        ...
        if (mapIndex != -1)
        {
            layers.Insert(mapIndex + 1, new LegacyGameInterfaceLayer(
                "MissionFramework: Mission Notification",
                delegate {
