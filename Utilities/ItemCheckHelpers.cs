...
/// <summary>
/// Helper methods for checking item properties and relationships.
/// </summary>
public static class ItemCheckHelpers
{
    ...
    /// <summary>
    /// Determines if an item is made from specified metal types, directly or indirectly through crafting.
    /// </summary>
    /// <param name="item"></param>
    /// <param name="metalTypes"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Determines if an item is made from any common metal types, directly or indirectly through crafting.
    /// </summary>
    /// <param name="item"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Determines if an item (by ID) is crafted with a specific ingredient.
    /// </summary>
    /// <param name="item"></param>
    ...
    /// <summary>
    /// Determines if an item is crafted with a specific ingredient.
    /// </summary>
    /// <param name="item"></param>
    /// <param name="ingredient"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Determines if an item is crafted from a specific base ingredient, directly or indirectly through crafting.
    /// </summary>
    /// <param name="item"></param>
