using MissionFramework.Core.Cinematics;
using MissionFramework.Core.Cinematics.Camera;
...
/// <summary>
/// Manages in-game dialogues, including queuing, zoom effects, and music handling
/// </summary>
