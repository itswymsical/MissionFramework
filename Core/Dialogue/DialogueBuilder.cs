...
/// <summary>
/// Builds dialogue sequences from localization data (used in .hjson files)
/// </summary>
public static class DialogueBuilder
{
    ...
    public static DialogueData BuildLine(string dialogueKey, string lineKey)
    {
        ...
        var textLocalization = MissionFramework.Instance.GetLocalization(textKey);
    ...
    private static string GetOptionalValue(string key, string defaultValue)
    {
        try
        {
            var localization = MissionFramework.Instance.GetLocalization(key);
