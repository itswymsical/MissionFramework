...
/// <summary>
/// A dialogue box that displays character portraits and text with various effects.
/// </summary>
public class DialogueBox : IInGameNotification
{
    ...
    private const string UI_ASSET_DIRECTORY = "MissionFramework/Assets/Textures/UI/";
    ...
    private void HandleInput()
    {
        ...
        if (MissionFrameworkSystem.FFDialogueKeybind.JustPressed)
        {
    ...
    private void DrawPanel(SpriteBatch spriteBatch)
    {
        ...
        PanelRenderer.DrawPanel(spriteBatch, panelRectangle, panelColor);
    ...
    private void DrawSkip(SpriteBatch spriteBatch)
    {
        ...
        Utils.DrawBorderString(spriteBatch, $"{MissionFrameworkSystem.FFDialogueKeybind.GetAssignedKeys().FirstOrDefault() ?? "[None]"}", new(arrowPosition.X - 20, arrowPosition.Y + 12), Color.White * Opacity, 0.75f, anchorx: 0f, anchory: 0.5f);
