...
using System.Linq;
using MissionFramework.Core.Cinematics.Music;

namespace MissionFramework.Core.Cinematics;

/// <summary>
/// Base class for creating cutscenes.
/// </summary>
public abstract class Cutscene
{
    ...
    public virtual void Start()
    {
        ...
        {
            ModContent.GetInstance<MissionFramework>().Logger.Error("Error starting cutscene: " + ex.Message);
        }
    }
    ...
    public virtual void Update(GameTime gameTime)
    {
        try
        {
            ...
            {
                if (MissionFrameworkSystem.SkipCutsceneKeybind.Current)
                {
                    _skipHoldTime++;
                    _isSkipping = true;
                    _skipAnimationTimer++;
        ...
        {
            ModContent.GetInstance<MissionFramework>().Logger.Error("Error updating cutscene: " + ex.Message);
        }
    }
    ...
    public virtual void DrawSkipIndicator(SpriteBatch spriteBatch)
    {
        ...
        string keybindName = MissionFrameworkSystem.SkipCutsceneKeybind.GetAssignedKeys().FirstOrDefault() ?? "[None]";
    ...
    public virtual void End()
    {
        ...
        {
            ModContent.GetInstance<MissionFramework>().Logger.Error("Error ending cutscene: " + ex.Message);
        }
    }
